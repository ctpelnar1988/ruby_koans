...
class AboutClassMethods < Neo::Koan
  ...
  # Answer: If you are going to be creating multiple class methods, putting
  # them inside of class << self ... end makes more sense to me. Otherwise, a
  # self.method_name will suffice.
